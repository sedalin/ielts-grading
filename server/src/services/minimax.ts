...
- Grammatical Range and Accuracy: 7.5分
  评语：There is a variety of complex structures, used flexibly and accurately. Grammar and punctuation are well controlled and there are frequent error-free sentences. A few errors persist [still the vast majority of people opt for (word order)] but the message is still clear.
